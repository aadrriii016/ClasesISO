...
# Administración de software de base (sistemas operativos, seguridad, scripting, redes)
...
# Administración y aseguramiento de la información (sistemas operativos, Windows, Linux, scripting, PowerShell, monitorización, resolución de incidencias)
...
# Administración de recursos compartidos (sistemas operativos, Windows, Linux, redes, scripting, PowerShell, seguridad)
...
# Administración de dominios (sistemas operativos, Windows, Linux, redes, scripting, PowerShell, seguridad, Directorio Activo)
...
# Administración del acceso al dominio (sistemas operativos, Windows, Linux, redes, scripting, PowerShell, seguridad, Directorio Activo)
...
# Supervisión del rendimiento del sistema (monitorización, rendimiento)
...
# Directivas de seguridad y auditorías (sistemas operativos, Windows, Linux, redes, scripting, PowerShell, seguridad, Directorio Activo)
...
# Resolución de incidencias y asistencia técnica (sistemas operativos, Windows, Linux, redes, scripting, PowerShell, seguridad, resolución de incidencias)
